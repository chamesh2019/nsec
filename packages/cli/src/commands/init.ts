...
import { generateUserKeyPair } from '@zvault/crypto';
import { createCredentialStore, type StorageMode } from '@zvault/keyring';
import { ZVaultApiClient, type ZVaultConfig } from '@zvault/core';
